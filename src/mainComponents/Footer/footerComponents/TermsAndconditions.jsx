...
const TermsAndConditions = () => {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <p className="text-sm text-gray-600 mb-6">Last updated: July 24, 2024</p>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-6 mb-4">
          ...
          <li className="mb-2"><strong>Country</strong> refers to: Haryana, India</li>
          <li className="mb-2"><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Rishab Kshetri.</li>
          ...
          <li className="mb-2"><strong>Website</strong> refers to Rishab Kshetri, accessible from https://kshetriai.com/</li>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
        By email: rishab@kshetriai.com
        </p>
        <p className="mb-4">
        By visiting this page on our website: <a className="text-blue-500" href="https://kshetriai.com/contact/"> https://kshetriai.com/contact/</a>
        </p>
      </section>
    </div>
  );
