  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-6 mb-4">
          ...
          <li className="mb-2">
            ...
            "Us" or "Our" in this Agreement) refers to Rishab Kshetri.
          </li>
          <li className="mb-2">
          ...
          <li className="mb-2">
            <strong>Website</strong> refers to Rishab Kshetri, accessible from
            https://kshetriai.com/
          </li>
          <li className="mb-2">
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-6 mb-4">
          <li>By email: rishab@kshetriai.com</li>
          <li>
            By visiting this page on our website:{" "}
            <a
              href="https://kshetriai.com/contact/"
              className="text-blue-600 hover:underline"
            >
              https://kshetriai.com/contact/
            </a>
          </li>
        </ul>
      </section>
