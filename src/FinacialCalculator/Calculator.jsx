...
function Calculator() {
  ...
  return (
    <div className="container mx-auto p-4 max-w-2xl bg-white dark:bg-gray-800 shadow-lg rounded-lg">
      ...
      <div className="mb-6 flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2">
        <input
          ...
          className="flex-grow p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-150 ease-in-out dark:bg-gray-700 dark:text-gray-200 dark:border-gray-600"
        />
        <input
          type="number"
          value={amount}
          ...
          placeholder="Amount"
          className="w-full sm:w-24 p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-150 ease-in-out dark:bg-gray-700 dark:text-gray-200 dark:border-gray-600"
        />
        <button
        ...
        <table className="w-full border-collapse border border-gray-300 dark:border-gray-600">
          <thead>
            <tr className="bg-gray-100 dark:bg-gray-700">
              <th className="border border-gray-300 dark:border-gray-600 p-2 text-gray-800 dark:text-gray-200">
                Debit
              </th>
              <th className="border border-gray-300 dark:border-gray-600 p-2 text-gray-800 dark:text-gray-200">
                Credit
      ...
      <div className="bg-gray-100 dark:bg-gray-700 p-4 rounded-md shadow-inner">
        ...
        <p className="mb-2 text-gray-800 dark:text-gray-200">
          Debit Total:{" "}
          <span className="font-medium">₹{totals.debitTotal.toFixed(2)}</span>
        </p>
        <p className="mb-2 text-gray-800 dark:text-gray-200">
          Credit Total:{" "}
